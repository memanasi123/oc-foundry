...
const moods = {
  ...
  melancholy: { visual: ["muted washed-out layers, a single treasured object worn smooth by handling, subtle signs of restraint in every choice", "quiet colors softened by grey, one striking texture that catches light, an overall silhouette that feels held-together but tired"], hook: ["They have been carrying a letter they cannot bring themselves to open for three months.", "They visit the same small place every week, and no one knows why—including them.", "The person they miss most has been dead longer than they were alive."], palette: ["#8B8B99", "#B5A8B0", "#D6C1B0", "#4D4550"] },
  chaotic: { visual: ["mismatched textures colliding, one bold accent that shouldn't work but does, layers that suggest they got dressed while running", "clashing patterns that somehow become their signature, an accessory that clearly wasn't planned but stayed", "asymmetric everything, chosen with confidence, held together by sheer force of personality"], hook: ["They have three plans, none compatible, and they're executing all of them today.", "They accidentally started a movement, and now people follow them, and now they can't stop.", "Every disaster they're near, they somehow make funnier and more useful at the same time."], palette: ["#FF6B6B", "#FFE66D", "#4ECDC4", "#5B4B8A"] }
};
